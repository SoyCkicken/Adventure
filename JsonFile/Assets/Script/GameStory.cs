...
//    //{
//    //    var list = jsonManager.storyMasters.Select.OrderBy(n => n.Chapter_Index).ThenBy(n => n.Event_Index).ThenBy(n => n.Scenc_Index);
//    //    mainQueue = new Queue<TRPGScriptDataScriptMasterMainData>(list);
//    //}
